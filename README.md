<p align="center">
  <img src="https://cdn.jsdelivr.net/npm/@wbc-ui/alert2/logo/alert2.svg" alt="@wbc-ui/alert2" width="220" style="max-width: 100%;"/>
</p>
...
<p align="center">
<a href="https://www.npmjs.com/package/@wbc-ui/alert2"><img src="https://img.shields.io/npm/v/@wbc-ui/alert2?color=1976D2" alt="npm"></a>
<a href="https://www.npmjs.com/package/@wbc-ui/alert2?activeTab=versions"><img src="https://img.shields.io/npm/dm/@wbc-ui/alert2?color=1976D2" alt="downloads"></a>
<a href="https://github.com/wbc-ui/alert2/blob/main/LICENSE"><img src="https://img.shields.io/npm/l/@wbc-ui/alert2?color=blue" alt="license"></a>
...
**@wbc-ui/alert2** replaces the bespoke notification/toast stack — per-severity components, a queue, layout logic — with a single `<WBAlert>` driven by an array of descriptors.
...
## What is @wbc-ui/alert2?

A **Vue 2.7+ component** — `<WBAlert>` — that renders a notification panel from a list of alert descriptors. Works standalone or as a plugin inside the `@wbc-ui/core2` (WBC) ecosystem.
...
```bash
yarn add @wbc-ui/alert2 vue@^2.7.16
pnpm add @wbc-ui/alert2 vue@^2.7.16
```
...
// main.js
import Vue from 'vue';
import WBAlertPlugin from '@wbc-ui/alert2';
Vue.use(WBAlertPlugin);
// Or import the component directly:
// import { WBAlert } from '@wbc-ui/alert2';
...
> **`@wbc-ui/alert2` is open-source and a complete notification component today** — the descriptor-driven panel, severities, layout, and WBC integration are free. The Pro lane follows the same open-core tiering as the underlying [`@wbc-ui/core2`](https://www.npmjs.com/package/@wbc-ui/core2) engine.
...
`@wbc-ui/alert2` is a sibling package in the **@wbc-ui** monorepo. Every package is published to npm and shares the same versioning line.
...
| **[`@wbc-ui/alert2`](https://www.npmjs.com/package/@wbc-ui/alert2)** | **Notification / toast system** *(this package)* | 🟢 GA |
